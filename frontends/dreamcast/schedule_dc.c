...
/* Helper to get monotonic time for scheduler */
static void scheduler_gettime(struct timeval *tv)
{
#ifdef __DREAMCAST__
...
void list_schedule(void)
{
	...
	NSLOG(netsurf, INFO, "schedule list at %lld:%ld", (long long)tv.tv_sec,
	      tv.tv_usec);
